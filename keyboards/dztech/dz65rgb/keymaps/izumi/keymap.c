...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_65_ansi(
            ...
            LT(2,KC_TAB),     KC_X,    KC_L,    KC_D,   KC_P,     KC_V,    KC_Z,    KC_K,    KC_O,    KC_U,    KC_SLSH, KC_LBRC, KC_RBRC, A(KC_BSPC), KC_DEL,
            LT(3,KC_CAPS),    KC_N,    KC_R,    KC_T,   KC_S,     KC_G,    KC_Y,    KC_H,    KC_E,    KC_I,    KC_A,    KC_SCLN, KC_ENT,           G(KC_TAB), 
            OSM(MOD_LSFT),    KC_J,    KC_M,    KC_C,   KC_W,     KC_Q,    KC_B,    KC_F,    KC_QUOT, KC_COMM,  KC_DOT, OSM(MOD_RSFT),    KC_UP,   G(KC_GRV),
    ...
    [4] = LAYOUT_65_ansi(
            _______, _______, _______, _______,     _______,    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
            _______, KC_HOME, KC_END, G(KC_LEFT),  G(KC_RGHT),  _______, _______, TG(6),   _______, _______, KC_BSPC, _______, _______, _______, _______, 
    ...
    [5] = LAYOUT_65_ansi(
            ...
            C(S(KC_SCLN)),        XXXXXXX, XXXXXXX, RGB_SPD, RGB_SPI, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, RGB_SAI, RGB_RMOD,
    ...
    [6] = LAYOUT_65_ansi(
            _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, 
            _______, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    TG(6),   KC_WH_D, KC_MS_U, KC_WH_U, _______, _______, _______, _______, KC_ACL2, 
